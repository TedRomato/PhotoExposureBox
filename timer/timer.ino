...
AnalogReader analogReader(0,1023,potNoiseThreshold,timerPotPin,minReadableVal,maxReadableVal);
...
void updateTimerValue() {
  timer = minTimerVal + timerTurnJump*analogReader.getCurrentValue();
}
